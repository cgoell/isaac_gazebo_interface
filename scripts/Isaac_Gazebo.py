...
pathtoworld = os.path.expanduser('~') + "/Desktop/Coastline_Map_all_UAVs/Terrain/Terrain_Demo.usdc"
...
def callback_cam2(data):
    ...
    global camoffset2
    camoffset2 = euler_from_quaternion(0.250, 0.250, 0.067, 0.933)

def heading_cam1(data):
    #Implement an heading for the gimbal camera of fixed wing 1 
    global headingc1
    headingc1 = data.data

def heading_cam2(data):
    #Implement an heading for the gimbal camera of fixed wing 2 
    global headingc2
    headingc2 = data.data
    print(headingc2)
...
def move():
    ...
    vtol1_prim.set_world_pose(position=np.array([vtol1_pose.position.x, vtol1_pose.position.y, vtol1_pose.position.z+0.25]),orientation=np.array([vtol1_pose.orientation.w, vtol1_pose.orientation.x, vtol1_pose.orientation.y, vtol1_pose.orientation.z]))
    vtol2_prim.set_world_pose(position=np.array([vtol2_pose.position.x, vtol2_pose.position.y, vtol2_pose.position.z+0.25]),orientation=np.array([vtol2_pose.orientation.w, vtol2_pose.orientation.x, vtol2_pose.orientation.y, vtol2_pose.orientation.z]))
