...
def move():
    ...
    auxarray1 = np.empty(4,dtype=float) 
    auxarray2= np.empty(3,dtype=float)
    ...
    auxarray1 = get_quaternion_from_euler(cam1frontarray[0], cam1frontarray[1], 0)
    ...
    vcamera1front_prim.set_local_pose(translation=np.array([0, 0, 0]),orientation=get_quaternion_from_euler(auxarray2[0],auxarray2[1],auxarray2[2]))
    #Fixed Wing 2
    ...
    auxarray1 = get_quaternion_from_euler(cam2frontarray[0], cam2frontarray[1], 0)
    auxarray1[3]= -auxarray1[3]
    auxarray2 =  euler_from_quaternion(auxarray1[1],auxarray1[2],auxarray1[3],auxarray1[0])
    auxarray2[0]+=camoffset2[0]
    auxarray2[1]+=camoffset2[1]
    auxarray2[2]+=camoffset2[2]
    vcamera2front_prim.set_local_pose(translation=np.array([0, 0, 0]),orientation=get_quaternion_from_euler(auxarray2[0],auxarray2[1],auxarray2[2]))
...
camoffset1 = np.empty(3,dtype=float)
camoffset1[0]=0
camoffset1[1]=0
camoffset1[2]=0
camoffset2 = np.empty(3,dtype=float)
camoffset2[0]=0
camoffset2[1]=0
camoffset2[2]=0
