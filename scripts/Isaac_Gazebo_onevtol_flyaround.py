...
#pathtoworld = os.path.expanduser('~') + "/Desktop/Coastline_Maps_small/Coastline_Map_one_VTOL/Terrain/Terrain_Demo.usdc"
pathtoworld = os.path.expanduser('~') + "/Desktop/Coastline_Maps_large/Coastline_Map_onevtol/Coastline_Map/Terrain_large.usd"
