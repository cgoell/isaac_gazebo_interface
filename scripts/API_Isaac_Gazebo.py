...
def move():
    ...
    vcamera1down_prim.set_local_pose(translation=np.array([0, 0, -0.5]),orientation=get_quaternion_from_euler(-cam1downarray[0]+camoffset[0], -cam1downarray[1]+camoffset[1], camoffset[2]))
    ...
    vcamera1front_prim.set_local_pose(translation=np.array([0, 0, -0.5]),orientation=auxarray)
    ...
    auxarray[3]= -auxarray[3]
    vcamera2front_prim.set_local_pose(translation=np.array([0, 0, -0.5]),orientation=auxarray)
